...
// VERAS — Renderizador COMPREI/PGFN V1.5.2 — PATCH PARA REPO render-comprei-v1-sharp
...
const SERVICE = 'render-comprei-v1-sharp-current-v1-5-2-satori-resvg-sharp-ttf';
const WIDTH = 1280;
const HEIGHT = 720;
